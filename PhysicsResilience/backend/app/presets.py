...
CONFIG_PRESETS = [
    ConfigPreset(id="vaulted", name="PowerProtect + vault", config=VAULTED,
    ...
    ConfigPreset(id="detecting", name="Cyber Detect on", config=DETECTING,
    ...
    ConfigPreset(id="mdr", name="MDR 24/7", config=MDR_247,
    ...
    ConfigPreset(id="zerotrust", name="Fort Zero · zero trust", config=ZT,
