...
export function UseCasePage() {
  ...
  // Union of every configured part's home regions — the plan, on the loop.
  ...
  return (
    <>
      ...
      <div className="stage">
        ...
        {uc && rows.length > 0 && (
          <div className="an-card uc-build">
            <h3>Plan sheet</h3>
            <p className="mini">
              What this scenario draws on, and why. Quantities count the unit
              named (devices, programs, reports).
            </p>
            <table>
              <thead>
                <tr>
      ...
      <aside className="controls">
        ...
        {anatomy && (
          <section className="an-panel">
            <h2>This plan on the loop</h2>
            <LoopView anatomy={anatomy} active={litRegions} />
            <div className="mini">
              Highlighted stages are where this scenario's choices act.
            </div>
          </section>
        )}
        <section className="an-panel">
