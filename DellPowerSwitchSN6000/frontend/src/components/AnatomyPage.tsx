        ...
        {anatomy && (
          <div className="an-card">
            ...
            <div className="mini an-hint">
              ...
              Follow the mesh lines — every leaf connects to every spine, so
              any rack reaches any other in two hops, and every one of those
              lines is another path adaptive routing can spread a congested
              flow onto.
            </div>
          </div>
        )}
