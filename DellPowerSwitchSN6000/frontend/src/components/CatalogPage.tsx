  ...
  return (
    <>
      <div className="an-hero">
        ...
        <p>
          An AI fabric is designed against collective traffic patterns, not
          user counts: pick the switch, then the topology and its
          oversubscription ratio, then the congestion machinery that keeps a
          saturated link from becoming a dropped packet. Hover a category to
          light up where its parts live in the topology.
        </p>
      </div>
