...
export function UseCasePage() {
  ...
  // Union of every configured part's home regions — the build, on the floorplan.
  ...
  return (
    <>
        ...
        {uc && rows.length > 0 && (
          <div className="an-card uc-build">
            ...
            <p className="mini">
              ...
              Quantities count the unit named — usually whole servers, since
              the 8-GPU box is the unit this product is bought and reasoned
              about in.
            </p>
            <table>
              <thead>
      ...
      <aside className="controls">
        ...
        {anatomy && (
          <section className="an-panel">
            <h2>This build in the chassis</h2>
            <ChassisView anatomy={anatomy} active={litRegions} />
            <div className="mini">
