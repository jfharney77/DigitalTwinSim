...
export const KIND_LABEL: Record<RegionKind, string> = {
  client: "storage data client",
  network: "IP fabric",
  coordinator: "metadata manager",
  node: "storage node",
  protection: "protection & rebuild",
  management: "lifecycle & telemetry",
};
        ...
        {anatomy && (
          <div className="an-card">
            ...
            <div className="mini an-hint">
              ...
              thing worth noticing in this diagram is an absence. Follow the
              lines from the client band: each one runs straight down to a
              storage node, with nothing in between. There is no controller
              row, because there is no controller — every node holds a share
              of every volume and answers clients directly. The metadata
              manager in the corner is drawn small on purpose: it maps
              chunks and referees failures, and never carries a byte of your
              data.
            </div>
          </div>
        )}
