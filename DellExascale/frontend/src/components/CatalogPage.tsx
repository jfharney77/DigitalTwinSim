...
import type { CatalogCategory, PlatformAnatomy } from "../types";
  ...
  return (
    <>
      <div className="an-hero">
        ...
        <p>
          An Exascale deployment is chosen along two axes: which storage
          engines you need in one rack — block, file, parallel file, object —
          and how much parallel bandwidth the GPU fleet demands, which is
          really a question about how many data servers you buy. Hover a
          category to light up where its parts live on the data path.
        </p>
      </div>
            ...
            <div className="mini">
              {active
                ? active.regionIds.length > 0
                  ...
                  : `${active.name} — not a drawn part of the path (validated designs or services).`
