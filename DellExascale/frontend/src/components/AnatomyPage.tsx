...
import type { Photo, RegionKind, PlatformAnatomy } from "../types";
        ...
        {anatomy && (
          <div className="an-card">
            ...
            <div className="mini an-hint">
              ...
              map reads left to right: GPU clients, the scale-out fabric,
              then the split that defines a parallel file system — the
              metadata server drawn <em>above</em> the path because it only
              answers "where are the stripes?", and the data servers carrying
              the actual bytes straight through the middle. The protocol
              engines along the bottom are what make one rack serve block,
              file, and object at once.
            </div>
          </div>
        )}
        {hovered && hover && (
