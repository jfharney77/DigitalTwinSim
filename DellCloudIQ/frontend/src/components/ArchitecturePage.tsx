...
export function ArchitecturePage() {
  ...
  // Honor a /#architecture/<regionId> deep link for the initial selection.
        ...
        {anatomy && (
          <div className="an-card">
            ...
            <div className="mini an-hint">
              ...
              is a stylized architecture diagram, not a chassis — the flow runs
              left to right: monitored Dell systems collect telemetry (far
              left), the Secure Connect Gateway ships it to Dell's cloud, the
              ML analytics and cybersecurity engines turn it into findings, and
              the insights, AIOps Assistant, and notifications deliver it (far
              right).
            </div>
          </div>
        )}
