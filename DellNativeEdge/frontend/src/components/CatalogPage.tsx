  ...
  return (
    <>
      <div className="an-hero">
        <h2>Capabilities</h2>
        <p>
          NativeEdge is a platform, and these are its moving parts: the
          endpoint hardware an estate is made of, the identity gate every
          device passes once, the Orchestrator and the blueprints it
          reconciles, the application catalog, and the security and
          observability planes that keep an unstaffed estate honest. Hover a
          category to light up where it lives on the architecture diagram.
        </p>
      </div>
