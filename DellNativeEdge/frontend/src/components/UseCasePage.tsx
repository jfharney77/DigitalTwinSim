...
export function UseCasePage() {
  ...
  // Union of every used capability's home regions — the scenario, on the diagram.
  ...
  return (
    <>
      ...
      <div className="stage">
        ...
        {uc && rows.length > 0 && (
          <div className="an-card uc-build">
            ...
            <p className="mini">
              Which parts of the platform this estate leans on, and why.
            </p>
            <table>
              <thead>
                <tr>
      ...
      <aside className="controls">
        ...
        {anatomy && (
          <section className="an-panel">
            <h2>This scenario on the diagram</h2>
            <PlatformView anatomy={anatomy} active={litRegions} />
            <div className="mini">
              Highlighted blocks are the platform areas this scenario uses.
            </div>
          </section>
        )}
        <section className="an-panel">
          ...
          <div className="btnrow">
            <button onClick={() => (window.location.hash = "architecture")}>
              See where these run
            </button>
            <button onClick={() => (window.location.hash = "capabilities")}>
