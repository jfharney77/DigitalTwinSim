...
// The build-to-order menu: every category is a physical slot in the chassis.
  ...
  return (
    <>
      <div className="an-hero">
        ...
        <p>
          The R760 is built to order: every category below fills a slot you
          can see on the chassis floorplan. Hover a category to light up
            ...
            <div className="mini">
              {active
                ? active.regionIds.length > 0
                  ...
                  : `${active.name} — mounts outside the chassis (rack rails, bezel).`
