...
// Data-driven switch floorplan renderer: draws whatever regions the backend
// sends, so a new switch is data (anatomy.py), not code — same principle as
// the R760 app's ChassisView. The `active` set lights regions up during the
// boot trace playback.
...
const KIND_STYLE: Record<RegionKind, { fill: string; stroke: string; text: string }> = {
  ports: { fill: "#12233a", stroke: "#3d5a9e", text: "#4f7cff" },
  uplink: { fill: "#122b2b", stroke: "#2e5c54", text: "#4fa08a" },
  poe: { fill: "#2b1a1a", stroke: "#6b3a3a", text: "#c97a6a" },
  asic: { fill: "#2b2412", stroke: "#6b5a2b", text: "#c9a94f" },
  cpu: { fill: "#241f33", stroke: "#4a4066", text: "#8a7ab5" },
  mgmt: { fill: "#12282e", stroke: "#2e5666", text: "#4fa0c9" },
  cooling: { fill: "#16281a", stroke: "#3a6647", text: "#6ab585" },
  power: { fill: "#1a2433", stroke: "#2b3a4f", text: "#8a9bb5" },
};
...
export function ChassisView({
  ...
  return (
    ...
    >
      ...
      {/* Orientation: front port/console face vs rear power/uplink face. */}
      <text
        x={MARGIN}
        y={H + 2.6}
        fill="#5a6b82"
