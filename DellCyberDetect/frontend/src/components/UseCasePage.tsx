  ...
  return (
    <>
        ...
        {uc && rows.length > 0 && (
          <div className="an-card uc-build">
            ...
            <p className="mini">
              ...
              Quantities count the capability named; this is a set of controls, not a parts list.
            </p>
            <table>
              <thead>
                <tr>
      ...
      <aside className="controls">
        ...
        {anatomy && (
          <section className="an-panel">
            <h2>This build in the detection map</h2>
            <TimelineView anatomy={anatomy} active={litRegions} />
            <div className="mini">
