"""Invariants for the reading-level system — the repo-shared mechanism
byte-for-byte; the leveled surfaces here are the panel-map overview and
region descriptions, the Explain entries, and the scenario narration."""
