...
// Every request carries the reader's current level. The backend resolves
// the prose server-side and returns plain strings, so the wire types are
// unchanged — see backend/app/leveling.py.
