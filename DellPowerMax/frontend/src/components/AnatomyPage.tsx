...
export function AnatomyPage() {
  ...
  // Legend shows only the kinds this floorplan actually has.
  const kinds = anatomy
        ...
        {anatomy && (
          <div className="an-card">
            ...
            <div className="mini an-hint">
              ...
              layout is a stylized top-down view of one node pair with the lid
              off — the shared NVMe drive enclosure (DME) at the front (left),
              and two mirror-image directors behind it: Node A on top, Node B
              below, joined by the InfiniBand Dynamic Fabric down the middle.
              An array is one or more of these node pairs.
            </div>
          </div>
        )}
        {hovered && hover && (
