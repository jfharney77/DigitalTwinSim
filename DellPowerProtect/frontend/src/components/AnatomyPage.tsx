...
import type { Photo, RegionKind, SiteAnatomy } from "../types";
...
export const KIND_LABEL: Record<RegionKind, string> = {
  ...
  appliance: "Data Domain appliance",
  gap: "operational air gap",
  analytics: "CyberSense analytics",
  recovery: "clean-room recovery",
  mgmt: "management planes",
};

// Swatches for the legend; keep in sync with KIND_STYLE in SiteView.
        ...
        {anatomy && (
          <div className="an-card">
            ...
            <div className="mini an-hint">
              ...
              map reads left to right, the way the data flows: the estate
              backs up to the production Data Domain; the air gap in the
              middle opens only when the vault opens it; and beyond the gap
              sit the vault Data Domain, CyberSense, and the clean room. The
              two appliances are drawn identical on purpose — what makes one
              of them a vault is not hardware but reachability.
            </div>
          </div>
        )}
        {hovered && hover && (
