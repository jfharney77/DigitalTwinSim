...
import type { CatalogCategory, SubsystemMap } from "../types";

// The capabilities menu: every category is unlocked in a block of the
// subsystem. Hovering a category lights up where it lives on the mini diagram.
  ...
  return (
    <>
      <div className="an-hero">
        <h2>Capabilities &amp; options</h2>
        <p>
          Most of what iDRAC does is unlocked by a license key, not bolted in
          as hardware — the same controller does more as you move up the tiers.
          Hover a category to light up the block it runs in.
        </p>
      </div>
            ...
            <div className="mini">
              {active
                ? active.regionIds.length > 0
                  ...
                  : `${active.name} — a software surface across the controller.`
                : "Hover a category to highlight the block it runs in."}
            </div>
          </section>
        )}
