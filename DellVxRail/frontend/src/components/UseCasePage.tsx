  ...
  return (
    <>
      ...
      <div className="stage">
        ...
        {uc && rows.length > 0 && (
          <div className="an-card uc-build">
            <h3>Build sheet</h3>
            <p className="mini">
              What goes into the cluster for this workload, and why. Per-node
              quantities are for the whole cluster (e.g. drives across all
              nodes).
            </p>
            <table>
              <thead>
      ...
      <aside className="controls">
        ...
        {anatomy && (
          <section className="an-panel">
            <h2>This build in the cluster</h2>
            <ClusterView anatomy={anatomy} active={litRegions} />
            <div className="mini">
