...
// Data-driven rack floorplan renderer: draws whatever regions the backend
...
export function RackView({
  ...
  return (
    ...
    >
      ...
      {/* Orientation: front-of-rack elevation; the liquid loop frames the right edge. */}
      <text x={MARGIN} y={H + 2.6} fill="#5a6b82" fontSize={1.7} letterSpacing={0.3}>
        FRONT — compute &amp; NVLink switch trays
      </text>
      <text
        x={W - MARGIN}
        y={H + 2.6}
