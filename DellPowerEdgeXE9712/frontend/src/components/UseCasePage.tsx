  ...
  return (
    <>
        ...
        {uc && rows.length > 0 && (
          <div className="an-card uc-build">
            ...
            <p className="mini">
              ...
              Quantities count the unit named — often whole racks, since the
              rack is the unit this product is bought and reasoned about in.
            </p>
            <table>
              <thead>
                <tr>
      ...
      <aside className="controls">
        ...
        {anatomy && (
          <section className="an-panel">
            <h2>This build in the rack</h2>
            <RackView anatomy={anatomy} active={litRegions} />
            <div className="mini">
